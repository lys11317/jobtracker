...
本项目是一个本地求职记录管理工具，包含 Chrome 和 Microsoft Edge 浏览器插件。插件可以从招聘页面读取公司、职位、投递时间、投递状态和链接，并在本地管理、筛选、编辑、导入或导出 CSV，Chrome 版支持生成 PDF。
...
4. 点击“管理器”查看全部记录，支持搜索、状态筛选、排序、状态下拉修改、CSV 导入导出和 PDF 生成。
